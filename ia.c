...
int x=0,y=0,z=0,I,J;                          /* COORDENADAS DA IA, x,y= posi��o do primeiro disparo em um navio (usado para atirar do outro lado caso n�o destrua)
...
void BordaBaseIA(){                             // DA VALOR "EDGE" �S BORDAS DA MATRIZ DE BASE(INT)
    int i,j;
...
void ProximoTiroIA(){                           // FUN��O USADA PARA ATIRAR NOS ARREDORES
